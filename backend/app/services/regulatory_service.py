...
class RegulatoryService:
    ...
    def create_ethics_submission(
        ...
        sub = EthicsSubmission(
            ...
            signature_metadata=payload.signature_metadata,
    ...
    def record_ethics_decision(
        ...
        if decision_data.document_url:
            sub.document_url = decision_data.document_url
        if decision_data.signature_metadata:
            sub.signature_metadata = decision_data.signature_metadata
