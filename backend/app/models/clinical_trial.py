...
class ClinicalTrial(Base):
    ...
    namaste_code: Mapped[Optional[str]] = mapped_column(String(50), nullable=True, index=True)
    icd11_tm_code: Mapped[Optional[str]] = mapped_column(String(50), nullable=True, index=True)
