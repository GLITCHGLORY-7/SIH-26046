...
class ClinicalTrialBase(BaseModel):
    ...
    namaste_code: Optional[str] = Field(None, max_length=50, description="Ministry of Ayush NAMASTE Morbidity Code")
    icd11_tm_code: Optional[str] = Field(None, max_length=50, description="WHO ICD-11 Chapter 26 Traditional Medicine Code")
...
class ClinicalTrialUpdate(BaseModel):
    ...
    icd11_tm_code: Optional[str] = None
