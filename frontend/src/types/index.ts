...
export interface AdverseEvent {
  ...
  expedited_notified_at?: string | null;
  signature_metadata?: any | null;
  created_at: string;
  updated_at: string;
...
export interface DashboardMetricsResponse {
  ...
  pending_ethics_reviews_count?: number;
  active_ethics_clearances_count?: number;
  open_sae_count?: number;
  pending_dcgi_notices_count?: number;
