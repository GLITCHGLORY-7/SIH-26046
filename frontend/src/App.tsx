        ...
        <Routes>
          ...
          >
            ...
            <Route
              path="/participants"
              element={
                <RoleGuard allowedRoles={['ADMIN', 'PRINCIPAL_INVESTIGATOR', 'STUDY_COORDINATOR', 'CLINICAL_TRIAL_MONITOR', 'PHARMACOVIGILANCE_OFFICER', 'REGULATOR']}>
                  <ParticipantsPage />
                </RoleGuard>
              }
            />
            ...
            <Route
              path="/ethics-regulatory"
              element={
                <RoleGuard allowedRoles={['ADMIN', 'PRINCIPAL_INVESTIGATOR', 'STUDY_COORDINATOR', 'CLINICAL_TRIAL_MONITOR', 'ETHICS_COMMITTEE', 'REGULATOR']}>
                  <EthicsRegulatoryPage />
                </RoleGuard>
              }
            />
            ...
            <Route
              ...
              element={
                <RoleGuard allowedRoles={['ADMIN', 'PRINCIPAL_INVESTIGATOR', 'REGULATOR']}>
            ...
            {/* Convenient Aliases & Route Shortcuts */}
            <Route path="/ethics" element={<Navigate to="/ethics-regulatory" replace />} />
            <Route path="/regulatory" element={<Navigate to="/ethics-regulatory" replace />} />
            <Route path="/audit" element={<Navigate to="/audit-logs" replace />} />
            <Route path="/interop" element={<Navigate to="/interoperability" replace />} />
            <Route path="/export" element={<Navigate to="/interoperability" replace />} />
          </Route>
